...
public class AES128 extends AES {
	...
	public static final int NUM_BYTES_IN_128_BIT_VERSION = 128 / 8;
	public static final int NUM_ROUNDS_IN_128_BIT_VERSION = 10;
	
	public AES128() {
		super();
		name = "AES128";
		numRounds = NUM_ROUNDS_IN_128_BIT_VERSION;
		keySize = NUM_BYTES_IN_128_BIT_VERSION;
	}
	...
	public int getNumActiveComponentsInKeySchedule() {
		return (int)(2.5 * (double)stateSize); // 10 / 4
	}
